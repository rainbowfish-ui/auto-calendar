...
const WeekView = () => {
  ...
  return (
    <section className="size-full">
      <div className="flex items-start justify-evenly w-full h-fit border-b-0 border-[0.5px]">
        {days.map((day, index) => {
          return (
            <div
              className="w-full py-4 flex items-center justify-center border-[0.5px] gap-2"
